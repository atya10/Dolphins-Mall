...
class _$ChangeTab extends ChangeTab {
  factory _$ChangeTab([void Function(ChangeTabBuilder)? updates]) =>
      (new ChangeTabBuilder()..update(updates))._build();

  _$ChangeTab._() : super._();

  @override
  ChangeTab rebuild(void Function(ChangeTabBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ChangeTabBuilder toBuilder() => new ChangeTabBuilder()..replace(this);
  ...
  @override
  String toString() {
    return newBuiltValueToStringHelper(r'ChangeTab').toString();
  }
}

class ChangeTabBuilder implements Builder<ChangeTab, ChangeTabBuilder> {
  _$ChangeTab? _$v;

  ChangeTabBuilder();

  @override
  void replace(ChangeTab other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$ChangeTab;
  }

  @override
  void update(void Function(ChangeTabBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ChangeTab build() => _build();

  _$ChangeTab _build() {
    final _$result = _$v ?? new _$ChangeTab._();
    replace(_$result);
    return _$result;
  }
}
